...
## Обзор
Нашь проект - это веб-приложение, которое анализирует код GitHub репозиториев, генерирует комплексную документацию и предоставляет интерактивный интерфейс для вопросов и визуализации зависимостей в проекте.
...
2. Фронтенд получает JSON с графом зависимостей
3. Отрисовка графа с возможностью:
   - Увеличения/уменьшения
   - Фильтрации по типу
   - Просмотра деталей при наведении
